        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Haz clic para ver más detalles de este Pokémon.</p>
              <a class="btn btn-primary" href="./details.html" onclick="verDetalle('${pokemon.url}')">Ver detalle</a>
            </div>
          </div>
        </div>`;
    });
