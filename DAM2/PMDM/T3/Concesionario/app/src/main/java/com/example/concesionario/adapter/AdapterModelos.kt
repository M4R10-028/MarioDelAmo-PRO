...
class AdapterModelos(var lista: ArrayList<Vehiculo>, var contexto : Context): BaseAdapter() {
    ...
    //me retorna el elemento ubicado en una posicion
    override fun getItem(position: Int): Vehiculo? {
        return lista[position]
    }

    //retorna el id del elemento ubicadp en una posicion
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        //1. Traer el XML para utilizarlo aquí
